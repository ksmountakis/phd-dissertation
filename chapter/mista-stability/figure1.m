...
%% med: 0.05, 0.10, 0.20, 0.40, 0.60
% 0.60 = (68.1, 11.54)
exn_mine=[97.78 88.49 81.03 72.3];
stb_mine=[0.207 0.922 1.96 6.27];

% 0.60 = (70.3, 9.10)
exn_mine2=[92.29 87.19 81.52 74.93];
stb_mine2=[0.29 0.69 1.66 4.44];
